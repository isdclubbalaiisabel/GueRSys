...
<head>
    ...
    <title>GRS - CONCERN CATEGORIES </title>
    <!-- Bootstrap CSS -->
    ...
    <div class="dashboard-main-wrapper">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Concern Categories</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
							...
							<form id="frm_new_record" name = "frm_new_record"  data-parsley-validate="" novalidate="">
								...
								<div class="card-body">
									...
									<div class="form-group row">
										<label for="cat_no" class="col-3 col-lg-3 col-form-label text-right">Category No</label>
										<div class="col-9 col-lg-9">
											<input name = "cat_no" id="cat_no" type="text" placeholder="" class="form-control" readOnly>
										</div>
									</div>
									<div class="form-group row">
										<label for="cat_desc" class="col-3 col-lg-3 col-form-label text-right">Category Name</label>
										<div class="col-9 col-lg-9">
											<input name = "cat_desc" id="cat_desc" type="text" required="" placeholder="Category Name" class="form-control">
										</div>
									</div>
									<div class="form-group row">
		...
		$(document).ready(function (e) {	
			$('#frm_new_record').on('submit',(function(e) {
				...
				e.preventDefault();
				$.ajax({
				url: "../ajax/save_new_concat.php", // Url to which the request is send
			...
			$("#all_items").on("click", "tr", function() {          
				...
				$.ajax({
					url: "../ajax/get_concat_data.php?r=" + name, // Url to which the request is send
					dataType: "JSON",
					success: function(result) {
						//$("#access_code").html(strMessage);
					
							//alert(result.data[0][0]);
							$("#cat_no").val(result.data[0][0]);
							$("#cat_desc").val(result.data[0][1]);
							$("#dept_code").val(result.data[0][2]);
