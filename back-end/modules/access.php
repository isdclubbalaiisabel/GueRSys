    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Access </h2>
				...
				<div class="row">
					...
					<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
						<div class="card">
							<form id="frm_new_record" name = "frm_new_record"  data-parsley-validate="" novalidate="">
								<h5 class="card-header">Accesss Information</h5>
								<div class="card-body">
								
									<div class="form-group row">
										<label for="access_code" class="col-3 col-lg-3 col-form-label text-right">Access Code</label>
										<div class="col-9 col-lg-9">
											<input name = "access_code" id="access_code" type="text" required="" placeholder="Access Code" class="form-control">
										</div>
									</div>
									<div class="form-group row">
										<label for="access_desc" class="col-3 col-lg-3 col-form-label text-right">Access Name</label>
										<div class="col-9 col-lg-9">
											<input name = "access_desc" id="access_desc" type="text" required="" placeholder="Access Description" class="form-control">
										</div>
									</div>
									<div class="form-group row">
					...
					<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
						<div class="card">
							<h5 class="card-header">All User Access</h5>
							<div class="card-body">
		...
		$(document).ready(function (e) {	
			$('#frm_new_record').on('submit',(function(e) {
				...
				e.preventDefault();
				$.ajax({
				url: "../ajax/save_new_access.php", // Url to which the request is send
			...
			$("#all_items").on("click", "tr", function() {          
				...
				$.ajax({
					url: "../ajax/get_access_data.php?r=" + name, // Url to which the request is send
					dataType: "JSON",
					success: function(result) {
						//$("#access_code").html(strMessage);
					
							//alert(result.data[0][0]);
							$("#access_code").val(result.data[0][0]);
							$("#access_code").prop("readOnly",true);
							$("#access_desc").val(result.data[0][1]);
