    ...
    <div class="dashboard-main-wrapper">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Departments </h2>
							...
							<form id="frm_new_record" name = "frm_new_record"  data-parsley-validate="" novalidate="">
								...
								<div class="card-body">
									...
									<div class="form-group row">
										<label for="dept_code" class="col-3 col-lg-3 col-form-label text-right">Dept. Code</label>
										<div class="col-9 col-lg-9">
											<input name = "dept_code" id="dept_code" type="text" required="" placeholder="Department Code" class="form-control">
										</div>
									</div>
									<div class="form-group row">
										<label for="dept_name" class="col-3 col-lg-3 col-form-label text-right">Dept. Name</label>
										<div class="col-9 col-lg-9">
											<input name = "dept_name" id="dept_name" type="text" required="" placeholder="Department Name" class="form-control">
										</div>
									</div>
									<div class="form-group row">
		...
		$(document).ready(function (e) {	
			$('#frm_new_record').on('submit',(function(e) {
				...
				e.preventDefault();
				$.ajax({
				url: "../ajax/save_new_dept.php", // Url to which the request is send
			...
			$("#all_items").on("click", "tr", function() {          
				...
				$.ajax({
					url: "../ajax/get_dept_data.php?r=" + name, // Url to which the request is send
					dataType: "JSON",
					success: function(result) {
						//$("#access_code").html(strMessage);
					
							//alert(result.data[0][0]);
							$("#dept_code").val(result.data[0][0]);
							$("#dept_code").prop("readOnly",true);
							$("#dept_name").val(result.data[0][1]);
