    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Concerns </h2>
				...
				<div class="row">
					...
					<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
						<div class="card">
							<form id="frm_new_record" name = "frm_new_record"  data-parsley-validate="" novalidate="">
								<h5 class="card-header">Concern Information</h5>
								<div class="card-body">
								
									<div class="form-group row">
										<label for="concern_no" class="col-3 col-lg-3 col-form-label text-right">Concern No</label>
										<div class="col-9 col-lg-9">
											<input name = "concern_no" id="concern_no" type="text" placeholder="" class="form-control" readOnly>
										</div>
									</div>
									<div class="form-group row">
										<label for="con_desc" class="col-3 col-lg-3 col-form-label text-right">Concern Desc</label>
										<div class="col-9 col-lg-9">
											<input name = "con_desc" id="con_desc" type="text" required="" placeholder="Concern Description" class="form-control">
										</div>
									</div>
									<div class="form-group row">
										<label for="cat_no" class="col-3 col-lg-3 col-form-label text-right">Category</label>
										<div class="col-9 col-lg-9">
											<select class="form-control" required=""  id="cat_no" name="cat_no">
									...
									<div class="form-group row">
										<label for="con_desc" class="col-3 col-lg-3 col-form-label text-right">Item Price</label>
										<div class="col-9 col-lg-9">
											<input name = "con_prc" id="con_prc" type="text"  placeholder="Price " class="form-control">
										</div>
									</div>
					...
					<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
						<div class="card">
							<h5 class="card-header">All Concerns</h5>
							<div class="card-body">
		...
		$(document).ready(function (e) {	
			$('#frm_new_record').on('submit',(function(e) {
				...
				e.preventDefault();
				$.ajax({
				url: "../ajax/save_new_concern.php", // Url to which the request is send
			...
			$.ajax({
				url: "../ajax/get_concats.php", // Url to which the request is send
				dataType: "text",
				success: function(strMessage) {
					$("#cat_no").html(strMessage);
				}
			});
			
			var table = $('#all_items').DataTable({ 
				"ajax": '../ajax/get_all_concerns.php',
				"order": [[ 0, "asc" ]],
			...
			$("#all_items").on("click", "tr", function() {          
				...
				$.ajax({
					url: "../ajax/get_concern_data.php?r=" + name, // Url to which the request is send
					dataType: "JSON",
					success: function(result) {
						//$("#access_code").html(strMessage);
					
							//alert(result.data[0][0]);
							$("#concern_no").val(result.data[0][0]);
							$("#con_desc").val(result.data[0][1]);
							$("#cat_no").val(result.data[0][2]);
							if(result.data[0][3] == 1){
